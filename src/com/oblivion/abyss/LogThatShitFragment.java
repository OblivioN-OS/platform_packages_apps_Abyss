...
import com.oblivion.abyss.utils.Helpers;
import com.oblivion.abyss.utils.Utils;
import com.oblivion.abyss.SuShell;
...
public class LogThatShitFragment extends Fragment {
    ...
    public static class SettingsPreferenceFragment extends PreferenceFragment {
        ...
        private static final String PREF_OBLIVION_LOG_IT = "oblivion_log_it";

        private static final String LOGCAT_FILE = new File(Environment
            .getExternalStorageDirectory(), "oblivion_logcat.txt").getAbsolutePath();
        private static final String KMSG_FILE = new File(Environment
            .getExternalStorageDirectory(), "oblivion_kmsg.txt").getAbsolutePath();
        private static final String DMESG_FILE = new File(Environment
            .getExternalStorageDirectory(), "oblivion_dmesg.txt").getAbsolutePath();

        private static final String HASTE_LOGCAT_KEY = new File(Environment
                .getExternalStorageDirectory(), "oblivion_haste_logcat_key").getAbsolutePath();
        private static final String HASTE_KMSG_KEY = new File(Environment
                .getExternalStorageDirectory(), "oblivion_haste_kmsg_key").getAbsolutePath();
        private static final String HASTE_DMESG_KEY = new File(Environment
                .getExternalStorageDirectory(), "oblivion_haste_dmesg_key").getAbsolutePath();

        private static final String OBLIVION_HASTE = "http://haste.aicp-rom.com/documents";
        private static final File sdCardDirectory = Environment.getExternalStorageDirectory();
        private static final File logcatFile = new File(sdCardDirectory, "oblivion_logcat.txt");
        private static final File logcatHasteKey = new File(sdCardDirectory, "oblivion_haste_logcat_key");
        private static final File dmesgFile = new File(sdCardDirectory, "oblivion_dmesg.txt");
        private static final File dmesgHasteKey = new File(sdCardDirectory, "oblivion_haste_dmesg_key");
        private static final File kmsgFile = new File(sdCardDirectory, "oblivion_kmsg.txt");
        private static final File kmsgHasteKey = new File(sdCardDirectory, "oblivion_haste_kmsg_key");
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mAicpLogIt = prefSet.findPreference(PREF_OBLIVION_LOG_IT);
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
            ...
            } else if (preference == mOblivionLogIt) {
