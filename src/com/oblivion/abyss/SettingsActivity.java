...
import com.oblivion.abyss.widget.SeekBarPreferenceCham;
...
public class SettingsActivity extends SubActivity {
    ...
    public static class SettingsActivityFragment extends PreferenceFragment
        ...
        private static final String PREF_TA_CUSTOM_COLORS = "ta_custom_colors";
        private static final String PREF_TA_NAV_DRAWER_OPACITY = "ta_drawer_opacity";
        private static final String PREF_TA_NAV_DRAWER_BG_COLOR = "ta_drawer_bg_color";
        private static final String PREF_TA_SETTINGS_RESTORE_DEFAULTS = "ta_settings_restore_defaults";
        private static final String PREF_TA_NAV_HEADER_BG_IMAGE_OPACITY = "ta_header_bg_image_opacity";
        private static final String PREF_TA_NAV_DRAWER_CHECKED_TEXT = "ta_nav_drawer_checked_text";
        private static final String PREF_TA_NAV_DRAWER_UNCHECKED_TEXT = "ta_nav_drawer_unchecked_text";
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mCustomColors = (SwitchPreference) prefSet.findPreference(PREF_TA_CUSTOM_COLORS);
            mCustomColors.setChecked(Settings.System.getInt(resolver,
                    Settings.System.TA_CUSTOM_COLORS, 0) != 0);
            mCustomColors.setOnPreferenceChangeListener(this);

            mNavDrawerOpacity = (SeekBarPreferenceCham) prefSet.findPreference(PREF_TA_NAV_DRAWER_OPACITY);
            mNavDrawerOpacity.setValue(Settings.System.getInt(resolver,
                    Settings.System.TA_NAV_DRAWER_OPACITY, 178));
            mNavDrawerOpacity.setOnPreferenceChangeListener(this);

            mNavDrawerBgColor = (ColorPickerPreference) prefSet.findPreference(PREF_TA_NAV_DRAWER_BG_COLOR);
            mNavDrawerBgColor.setOnPreferenceChangeListener(this);
            intColor = Settings.System.getInt(resolver,
                    Settings.System.TA_NAV_DRAWER_BG_COLOR, DEFAULT_NAV_HEADER_COLOR);
            ...
            mNavHeaderBgImageOpacity = (SeekBarPreferenceCham) prefSet.findPreference(PREF_TA_NAV_HEADER_BG_IMAGE_OPACITY);
            mNavHeaderBgImageOpacity.setValue(Settings.System.getInt(resolver,
                    Settings.System.TA_NAV_HEADER_BG_IMAGE_OPACITY, 200));
            mNavHeaderBgImageOpacity.setOnPreferenceChangeListener(this);

            mNavDrawerTextCheckedColor = (ColorPickerPreference) prefSet.findPreference(PREF_TA_NAV_DRAWER_CHECKED_TEXT);
            mNavDrawerTextCheckedColor.setOnPreferenceChangeListener(this);
            intColor = Settings.System.getInt(resolver,
                    Settings.System.TA_NAV_DRAWER_CHECKED_TEXT, 0xffffab00);
            ...
            mNavDrawerTextUncheckedColor = (ColorPickerPreference) prefSet.findPreference(PREF_TA_NAV_DRAWER_UNCHECKED_TEXT);
            mNavDrawerTextUncheckedColor.setOnPreferenceChangeListener(this);
            intColor = Settings.System.getInt(resolver,
                    Settings.System.TA_NAV_DRAWER_UNCHECKED_TEXT, 0xFFFFFFFF);
            hexColor = String.format("#%08x", (0xFFFFFFFF & intColor));
            mNavDrawerTextUncheckedColor.setSummary(hexColor);
            mNavDrawerTextUncheckedColor.setNewPreviewColor(intColor);

            mAeRestoreDefaults = prefSet.findPreference(PREF_TA_SETTINGS_RESTORE_DEFAULTS);
        }
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (preference == mCustomColors) {
                ...
                Settings.System.putInt(resolver,
                        Settings.System.TA_CUSTOM_COLORS, enabled);
                return true;
            } else if (preference == mNavDrawerOpacity) {
                int alpha = ((Integer) newValue).intValue();
                Settings.System.putInt(resolver,
                        Settings.System.TA_NAV_DRAWER_OPACITY, alpha);
                return true;
                ...
                Settings.System.putInt(resolver,
                        Settings.System.TA_NAV_DRAWER_BG_COLOR, intHex);
                return true;
            } else if (preference == mNavHeaderBgImageOpacity) {
                int alpha = ((Integer) newValue).intValue();
                Settings.System.putInt(resolver,
                        Settings.System.TA_NAV_HEADER_BG_IMAGE_OPACITY, alpha);
                return true;
                ...
                int intHex = ColorPickerPreference.convertToColorInt(hex);
                Settings.System.putInt(resolver,
                        Settings.System.TA_NAV_DRAWER_CHECKED_TEXT, intHex);
                return true;
                ...
                int intHex = ColorPickerPreference.convertToColorInt(hex);
                Settings.System.putInt(resolver,
                        Settings.System.TA_NAV_DRAWER_UNCHECKED_TEXT, intHex);
                return true;
            }
            return false;
        }
